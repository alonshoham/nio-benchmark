 ...
 * the server.
 */
public class NettyEpollBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Options opt = new OptionsBuilder()
                .include(NettyEpollBenchmark.class.getName())
                .forks(1)
                .threads(threads)
    ...
    @Benchmark
    public void test(NettyEpollClient nettyEpollClient){
        nettyEpollClient.sendMessage("message-" + new Random().nextInt(100));
    }
